...
% Examples - Done
\textbf{Neural Compression and Task-Aware Compression:} In the context of this project, two promising developments in this area will explored: task-aware compression and neural compression. 
...
\textbf{Limitations of Existing Work:} There are two major limitations with the examples discussed above:
\begin{itemize}
