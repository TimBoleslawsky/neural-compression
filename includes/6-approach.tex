...
\begin{itemize}
    \item \textbf{Dataset:} The dataset will focus on available automotive sensor and telemetry test-fleet data supporting tasks such as predictive maintenance and anomaly detection. Alternatively, publicly available datasets such as the SCANIA Component X Dataset can be used \citep{kharazian2025}.
